...
import HOSTING_SERVICE_API from '../../../services/services/hostingService';
  ...
  return (
    <Box>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
        ...
        {hasPermission(PERMISSIONS.HOSTING_SERVICE.ADD) && (
          <Button
            variant="contained"
            startIcon={<IconPlus />}
            onClick={handleAdd}
      ...
      {hasPermission(PERMISSIONS.HOSTING_SERVICE.VIEW) ? (
      <>
                  ...
                  return (
                    <>
                      <TableRow hover role="checkbox" tabIndex={-1} key={row._id || row.id}>
                        ...
                        <TableCell>
                          {hasPermission(PERMISSIONS.HOSTING_SERVICE.UPDATE) && (
                            <IconButton 
                              color="primary" 
                          ...
                          {hasPermission(PERMISSIONS.HOSTING_SERVICE.DELETE) && (
                            <IconButton 
                              color="error" 
                          ...
                          <Collapse in={isOpen} timeout="auto" unmountOnExit>
                            <Box sx={{ display: 'flex', flexDirection: 'row', gap: 2 }}>
                              <Box margin={1} sx={{ flex: 1 }}>
                                <Typography variant="subtitle1">Chi tiết dịch vụ hosting</Typography>
